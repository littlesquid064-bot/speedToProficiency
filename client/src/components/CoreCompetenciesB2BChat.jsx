...
const QUESTIONS = [
    {
        id: 'q1',
        question: 'In B2B sales, what is the PRIMARY objective of a discovery call?',
        options: ['Present full product demo', 'Understand decision-maker’s designation', 'Identify business pain, impact, and buying process', 'Share pricing sheet'],
        correct: 2,
        explanation: 'Correct! Discovery is about diagnosing business impact, not pitching prematurely.',
        wrongExplanation: 'Discovery is for diagnosing pain and buying process, not pitching.'
    },
    {
        id: 'q2',
        question: 'A deal is stuck after proposal submission. What is the MOST likely reason?',
        options: ['Pricing too high', 'No identified economic buyer', 'Proposal format issue', 'CRM not updated'],
        correct: 1,
        explanation: 'Correct! Most deals stall because reps fail to engage the economic decision-maker.',
        wrongExplanation: 'Deals stall when the economic buyer is not engaged.'
    },
    {
        id: 'q3',
        question: 'What does a strong B2B qualification framework ensure?',
        options: ['Faster demos', 'Better follow-up emails', 'Time invested only in high-probability deals', 'Higher discounting'],
        correct: 2,
        explanation: 'Correct! Qualification frameworks ensure reps prioritize winnable, viable opportunities.',
        wrongExplanation: 'Qualification is about focusing on high-probability deals.'
    },
    {
        id: 'q4',
        question: 'If a prospect says, “Send me details, we’ll get back,” the BEST response is:',
        options: ['Send brochure immediately', 'Push for immediate closure', 'Ask about evaluation criteria and timeline', 'Offer discount'],
        correct: 2,
        explanation: 'Correct! A structured follow-up question helps uncover buying intent and next steps.',
        wrongExplanation: 'Ask about evaluation criteria and timeline to uncover intent.'
    },
    {
        id: 'q5',
        question: 'Forecast accuracy depends MOST on:',
        options: ['Optimism', 'Pipeline volume', 'Clear deal stage exit criteria', 'Senior management pressure'],
        correct: 2,
        explanation: 'Correct! Defined stage criteria are key for enterprise-grade forecasting.',
        wrongExplanation: 'Forecasting depends on clear stage exit criteria.'
    }
];

const INTRO_SEQUENCE = [
    'Welcome to the **Core Competencies: B2B Sales** module! 🏛️ I\'m your Learning Genie, and I\'ll guide you through this session interactively.',
    'This module covers consultative selling, commercial acumen, stakeholder management, and pipeline discipline.',
...
const CoreCompetenciesB2BChat = ({ results = {}, careerPath = [], modules = [], user = {} }) => {
            ...
            if (nextIdx < QUESTIONS.length) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        const msg = pct >= 80
                            ? `🎉 Outstanding! You've demonstrated solid B2B sales knowledge — you're ready for the next module!`
                            : `Good effort! Review the explanations above and retry — every rep builds the muscle memory you'll need in enterprise sales.`;
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5, flexWrap: 'wrap' }}>
                            ...
                            <span style={{ fontWeight: 700, fontSize: 14, color: '#1a202c' }}>Core Competencies: B2B Sales</span>
                            <span style={{
...
export default CoreCompetenciesB2BChat;
