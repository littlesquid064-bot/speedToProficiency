...
const QUESTIONS = [
    {
        id: 'ea1',
        question: 'When diagnosing a legacy enterprise environment, what is the FIRST thing you should map?',
        options: ['CPU utilization metrics', 'Data flow and system dependencies', 'Cost of existing licenses', 'Number of end-users'],
        correct: 1,
        explanation: 'Correct! Understanding data flows and dependencies is critical for any migration or deployment strategy.',
        wrongExplanation: 'Always start with data flows and dependencies to understand the architectural constraints.'
    },
    {
        id: 'ea2',
        question: 'A client requires data residency within a specific region but uses a global SaaS product. What is the most robust architecture?',
        options: ['Block all outgoing traffic', 'Implement a local data gateway with anonymization', 'Request the SaaS provider to move their entire cloud', 'Use local spreadsheets instead'],
        correct: 1,
        explanation: 'Correct! A local gateway allows for compliance while still utilizing global services.',
        wrongExplanation: 'Local data gateways with anonymization are standard for residency requirements.'
    },
    {
        id: 'ea3',
        question: 'Which factor is most critical when designing for "Scalability" in a hybrid cloud deployment?',
        options: ['Maximum possible speed', 'Loose coupling of components', 'Lowest vertical cost', 'Color of the server racks'],
        correct: 1,
        explanation: 'Correct! Loose coupling ensures that individual components can scale independently without breaking the system.',
        wrongExplanation: 'Loose coupling is the bedrock of scalable architectures.'
    },
    {
        id: 'ea4',
        question: 'How should you handle security bottlenecks discovered during production readiness?',
        options: ['Disable security checks to meet the deadline', 'Ignore them if internal', 'Evaluate the risk and implement compensating controls or fix the bottleneck', 'Let the client handle it post-go-live'],
        correct: 2,
        explanation: 'Correct! Identifying risks and implementing controls is key for maintaining architectural integrity.',
        wrongExplanation: 'Security bottlenecks must be addressed or mitigated with controls before deployment.'
    },
    {
        id: 'ea5',
        question: 'What defines a "Repeatable Deployment Pattern" in Enterprise Tech?',
        options: ['Manual documentation only', 'Hardcoded configuration for one client', 'Infrastructure-as-Code (IaC) with modular templates', 'Using the same password everywhere'],
        correct: 2,
        explanation: 'Correct! IaC allows engineers to turn custom work into automated, repeatable patterns.',
        wrongExplanation: 'Infrastructure-as-Code is essential for repeatable, automated deployment patterns.'
    }
];

const INTRO_SEQUENCE = [
    'Welcome to the **Enterprise Architecture Mastery** module! 🏢 I\'m your Learning Genie, and I\'ll guide you through this session interactively.',
    'As a Forward Deployment Engineer, your role is to bridge the gap between our product and complex client environments.',
    'Let\'s dive into some architectural scenarios to see how you\'d handle real-world deployment challenges. Ready? ⚒️'
];
...
const EnterpriseArchitectureMasteryChat = ({ results = {}, careerPath = [], modules = [], user = {} }) => {
            ...
            if (nextIdx < QUESTIONS.length) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        const msg = pct >= 80
                            ? `🎉 Excellent! Your architectural diagnosis and strategy skills are sharp. You're ready to lead complex deployments!`
                            : `Good attempt! Building robust enterprise systems takes practice. Review these patterns and you'll be deploying at scale in no time!`;
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5, flexWrap: 'wrap' }}>
                            ...
                            <span style={{ fontWeight: 700, fontSize: 14, color: '#1a202c' }}>Enterprise Architecture Mastery</span>
                            <span style={{
...
export default EnterpriseArchitectureMasteryChat;
