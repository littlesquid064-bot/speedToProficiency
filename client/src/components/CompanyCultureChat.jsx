...
const QUESTIONS = [
    {
        id: 'q1',
        question: 'What is the MAIN purpose of company values?',
        options: ['To decorate the office walls', 'To guide decision-making and behavior', 'To impress clients', 'To set sales targets'],
        correct: 1,
        explanation: 'Correct! Company values guide decisions and behavior, shaping culture and priorities.',
        wrongExplanation: 'Company values are meant to guide behavior and decisions, not just decorate walls.'
    },
    {
        id: 'q2',
        question: 'How does org structure impact your daily work?',
        options: ['It determines reporting lines and collaboration', 'It affects office layout', 'It sets product pricing', 'It has no impact'],
        correct: 0,
        explanation: 'Correct! Org structure determines reporting, collaboration, and decision-making.',
        wrongExplanation: 'Org structure impacts reporting and collaboration.'
    },
    {
        id: 'q3',
        question: 'What is the best way to understand company policies?',
        options: ['Ignore them', 'Ask your manager', 'Read the employee handbook and ask questions', 'Wait for HR emails'],
        correct: 2,
        explanation: 'Correct! Reading the handbook and asking questions ensures clarity and compliance.',
        wrongExplanation: 'Always read the handbook and ask questions for clarity.'
    },
    {
        id: 'q4',
        question: 'Why is cultural fluency important in sales conversations?',
        options: ['It helps build authentic relationships', 'It increases commission', 'It speeds up onboarding', 'It reduces paperwork'],
        correct: 0,
        explanation: 'Correct! Cultural fluency builds authentic relationships and trust.',
        wrongExplanation: 'Cultural fluency is key for authentic relationships.'
    },
    {
        id: 'q5',
        question: 'How are decisions typically made in a company?',
        options: ['By random selection', 'Through structured processes and stakeholder input', 'By the loudest person', 'By HR only'],
        correct: 1,
        explanation: 'Correct! Structured processes and stakeholder input drive decision-making.',
        wrongExplanation: 'Decisions are made through structured processes and input.'
    }
];

const INTRO_SEQUENCE = [
    'Welcome to the **Company Culture & Foundations** module! 🏛️ I\'m your Learning Genie, and I\'ll guide you through this session interactively.',
    'This module covers values, org structure, policies, and cultural fluency. These are essential for authentic sales conversations.',
...
const CompanyCultureChat = ({ results = {}, careerPath = [], modules = [], user = {} }) => {
            ...
            if (nextIdx < QUESTIONS.length) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        const msg = pct >= 80
                            ? `🎉 Outstanding! You've demonstrated solid company culture knowledge — you're ready for the next module!`
                            : `Good effort! Review the explanations above and retry — every rep builds the muscle memory you'll need in sales conversations.`;
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5, flexWrap: 'wrap' }}>
                            ...
                            <span style={{ fontWeight: 700, fontSize: 14, color: '#1a202c' }}>Company Culture & Foundations</span>
                            <span style={{
...
export default CompanyCultureChat;
