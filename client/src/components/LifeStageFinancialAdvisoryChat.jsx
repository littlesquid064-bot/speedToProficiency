...
const QUESTIONS = [
    {
        id: 'ls1',
        question: 'A client in their late 20s just got a significant promotion. What is the most appropriate financial advisory "next step"?',
        options: ['Suggest immediate retirement with current savings', 'Recommend high-risk crypto speculation', 'Discuss tax-efficient investment vehicles and emergency fund scaling', 'Ask them to buy a luxury car'],
        correct: 2,
        explanation: 'Correct! Increasing income should be met with tax planning and strengthening financial foundations.',
        wrongExplanation: 'Focus on tax efficiency and building a robust emergency fund as income increases.'
    },
    {
        id: 'ls2',
        question: 'When assessing "Risk Appetite" for a client nearing retirement, what is the CRITICAL factor?',
        options: ['Market hype', 'Time horizon and need for capital preservation', 'Total number of children', 'Current interest in tech stocks'],
        correct: 1,
        explanation: 'Correct! Preservation becomes the priority as the time horizon for recovery from market downturns shrinks.',
        wrongExplanation: 'Time horizon and capital preservation are the most critical factors for clients near retirement.'
    },
    {
        id: 'ls3',
        question: 'Which of these is a "Life-Stage Trigger" for a proactive advisory outreach?',
        options: ['Client follows a new celebrity on social media', 'Birth of a child or marriage', 'Client moves to a different neighborhood (within same city)', 'Client changes their email provider'],
        correct: 1,
        explanation: 'Correct! Major life events significantly shift financial goals and insurance needs.',
        wrongExplanation: 'Major events like marriage or childbirth are key triggers for financial re-planning.'
    },
    {
        id: 'ls4',
        question: 'How do you handle a "Cross-Sell" opportunity without appearing pushy?',
        options: ['Wait for the client to ask', 'Force them to sign up for everything during the first call', 'Anchor the recommendation to a specific life goal identified in discovery', 'Offer a discount if they buy today only'],
        correct: 2,
        explanation: 'Correct! Goal-based selling builds trust and ensures the product is actually relevant to the client.',
        wrongExplanation: 'Always anchor products to the client\'s specific goals to build trust.'
    },
    {
        id: 'ls5',
        question: 'What is the primary goal of "Portfolio Rebalancing"?',
        options: ['To maximize daily profits', 'To maintain the desired risk-return profile over time', 'To increase the number of total assets', 'To follow the latest news trends'],
        correct: 1,
        explanation: 'Correct! Rebalancing ensures that market fluctuations don\'t leave the client over-exposed to one asset class.',
        wrongExplanation: 'Rebalancing is about maintaining the specific risk-return profile the client agreed to.'
    }
];

const INTRO_SEQUENCE = [
    'Welcome to the **Life-Stage Financial Advisory** module! 💵 I\'m your Learning Genie, and I\'ll help you master the art of relationship-based advisory.',
    'As a Relationship Manager, you aren\'t just selling products—you\'re securing futures.',
    'Let\'s dive into some client scenarios to see how you\'d align financial tools with human goals. Ready? 🎯'
];
...
const LifeStageFinancialAdvisoryChat = ({ results = {}, careerPath = [], modules = [], user = {} }) => {
            ...
            if (nextIdx < QUESTIONS.length) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        const msg = pct >= 80
                            ? `🎉 Fantastic! You have a great instinct for goal-based advisory. Your clients are in good hands!`
                            : `Good try! Advisory is about empathy as much as finance. Review the life-stage triggers and you'll be a top RM soon!`;
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5, flexWrap: 'wrap' }}>
                            ...
                            <span style={{ fontWeight: 700, fontSize: 14, color: '#1a202c' }}>Life-Stage Financial Advisory</span>
                            <span style={{
...
export default LifeStageFinancialAdvisoryChat;
