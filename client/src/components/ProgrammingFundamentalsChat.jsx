...
const QUESTIONS = [
    {
        ...
        correct: 1,
        explanation: 'Correct! Binary search halves the search space with each step, leading to logarithmic time complexity.',
        wrongExplanation: 'Not quite. Binary search is O(log n) because it divides the array in half each step.'
    },
    {
        id: 'q2',
        question: 'Which of the following best describes encapsulation in OOP?',
        options: ['Inheriting properties from another class', 'Wrapping data and methods together and restricting direct access', 'Creating multiple methods with same name', 'Running code in parallel'],
        correct: 1,
        explanation: 'Correct! Encapsulation protects internal object state and exposes controlled interfaces.',
        wrongExplanation: 'Encapsulation means wrapping data and methods together and restricting direct access.'
    },
    {
        id: 'q3',
        question: 'If your program runs but produces incorrect output, this is typically a:',
        options: ['Syntax error', 'Logical error', 'Compilation error', 'Version control error'],
        correct: 1,
        explanation: 'Correct! Logical errors occur when code runs successfully but the logic is flawed.',
        wrongExplanation: 'Logical errors are when code runs but produces wrong results.'
    },
    {
        id: 'q4',
        question: 'What is the PRIMARY purpose of version control systems like Git?',
        options: ['Store code locally', 'Increase execution speed', 'Track changes and enable collaboration', 'Compile programs'],
        correct: 2,
        explanation: 'Correct! Version control helps track changes, collaborate safely, and manage code history.',
        wrongExplanation: 'Version control is for tracking changes and collaboration.'
    },
    {
        id: 'q5',
        question: 'What is the BEST first step when debugging a failing feature?',
        options: ['Rewrite the entire module', 'Blame dependencies', 'Reproduce the issue consistently', 'Deploy a quick fix'],
        correct: 2,
        explanation: 'Correct! Reproducibility is fundamental to structured debugging.',
        wrongExplanation: 'Always reproduce the issue consistently before debugging.'
    }
];

const INTRO_SEQUENCE = [
    'Welcome to the **Programming Fundamentals** module! 💻 I\'m your Learning Genie, and I\'ll guide you through this session interactively.',
    'This module covers core programming concepts, OOP, debugging, and version control. These are the foundations for every developer.',
    'You\'re already starting strong! Let\'s pick up with some scenario-based questions. Answer each one and I\'ll explain the reasoning behind every answer. Ready? 🎯'
];
...
const ProgrammingFundamentalsChat = ({ results = {}, careerPath = [], modules = [], user = {} }) => {
            ...
            if (nextIdx < QUESTIONS.length) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        const msg = pct >= 80
                            ? `🎉 Outstanding! You've demonstrated solid programming fundamentals — you're ready for the next module!`
                            : `Good effort! Review the explanations above and retry — every rep builds the muscle memory you'll need as a developer.`;
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5, flexWrap: 'wrap' }}>
                            ...
                            <span style={{ fontWeight: 700, fontSize: 14, color: '#1a202c' }}>Programming Fundamentals</span>
                            <span style={{
...
export default ProgrammingFundamentalsChat;
